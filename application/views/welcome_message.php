      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li>
              <a href="<?php echo base_url().'users/c_fund_transfer'; ?>">
                <i class="fa fa-bank"></i> <span>Transfer To Friend's Account</span>
              </a>
            </li>
            <li>
              <a href="#">
                <i class="fa fa-calendar"></i> <span>Transcation Record</span>
              </a>
            </li>
            <li>
              <a href="#">
